...
const festivalData = {
  ML: {
    ...
    items: [
      ...
      "വിഷു ഉത്സവത്തോടനുബന്ധിച്ച്  മൂലസ്വരൂപമായ ഉള്ളാട്ടുകാവിൽനിന്നും ഏഴുദിവസം  വാളെഴുന്നള്ളത് , ഏഴാമത്തെ ദിവസമായ വിഷുദിവസം കണ്യാർകളിയും ഉണ്ടായിരിക്കുന്നതാണ്.",
  ...
  EN: {
    ...
    items: [
      ...
      "As part of the Vishu festival celebrations, the ceremonial sword procession (Vaal Ezhunnallathu) is conducted for seven days from the original shrine, Ullattukavu. On the seventh day, which is Vishu day, Kanyar Kali is also held.",
  ...
  TA: {
    ...
    items: [
      ...
      "விஷு திருவிழா கொண்டாட்டங்களின் ஒரு பகுதியாக, மூலஸ்தலமான உள்ளாட்டுக்காவிலிருந்து ஏழு நாட்களுக்கு வாள் எழுநள்ளத்து (சடங்கு வாள் ஊர்வலம்) நடைபெறுகிறது. ஏழாவது நாளான விஷு தினத்தில், கண்ணியார் களியும் சிறப்பாக நடைபெறுகிறது.",
